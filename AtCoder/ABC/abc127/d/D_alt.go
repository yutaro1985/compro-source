...
func (a SortByC) Len() int           { return len(a) }
func (a SortByC) Swap(i, j int)      { a[i], a[j] = a[j], a[i] }
func (a SortByC) Less(i, j int) bool { return a[i].C > a[j].C }
