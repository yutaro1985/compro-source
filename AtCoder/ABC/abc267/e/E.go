...
// 答えを二分探索する方法
// 考え方
// https://twitter.com/kyopro_friends/status/1566068163082878976
// > 「答えがX以下になるか？」は「『コストがX以下の頂点を1つ選んで削除する』をN回繰り返せるか？」と同じ
...
func main() {
	...
	ans := sort.Search(1e18, func(mid int) bool {
		C := make([]int, N)
		copy(C, Cost)
		deleted := make([]bool, N)
		q := list.New()
